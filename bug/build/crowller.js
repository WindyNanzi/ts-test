...
var movieAnalysis_1 = require("./movieAnalysis");
var Crowller = /** @class */ (function () {
    function Crowller(Analysis) {
        this.Analysis = Analysis;
        this.filePath = path_1.default.resolve(__dirname, '../data/movies.json');
        this.url = "https://movie.douban.com/";
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        html = _a.sent();
                        fileContent = this.Analysis.analysis(html, this.filePath);
...
var movieAnalysis = movieAnalysis_1.MovieAnalysis.getInstance();
